...
public class Rabbit {
    ...
    //Mai Ngar => zMaiNgarz
    private static String input_paoh_zawgyi(String output){
        String rule = "[{\"from\":\"\\u109E\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\u1052\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\u109F\",\"to\":\"zMaiNgarz\"},{\"from\":\"\\u1053\",\"to\":\"zMaiNgarz\"}]";
        return replace_with_rule(rule,output);
    }

    private static String input_paoh_unicode(String output){
        String rule = "[{\"from\":\"\\u108F\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\uAA7B\",\"to\":\"zMaiNgarz\"}]";
        return replace_with_rule(rule,output);
    }
    ...
    //zMaiPatNgarz => u1052
    //zMaiNgarz => u1053
    private static String output_paoh_zawgyi(String output){
        String rule = "[{\"from\":\"zMaiPatNgarz\",\"to\":\"\\u1052\"},{\"from\":\"zMaiNgarz\",\"to\":\"\\u1053\"}]";
        return replace_with_rule(rule,output);
    }
    ...
    //zMaiPatNgarz => u108F
    //zMaiNgarz => uAA7B
    private static String output_paoh_unicode(String output){
        String rule = "[{\"from\":\"zMaiPatNgarz\",\"to\":\"\\u108F\"},{\"from\":\"zMaiNgarz\",\"to\":\"\\uAA7B\"}]";
        return replace_with_rule(rule,output);
    }

    private static String replace_with_rule(String rule,String output) {
